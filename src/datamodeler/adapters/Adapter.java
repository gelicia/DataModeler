...
public interface Adapter {
	 ...
	 * @param port the port (the adapter specifies a default port if not specified)
	 * @param username the username to give the server
	 * @param password the password to give the server
	 * @return A string that can be used with DriverManager.getConnection(String string)
	 */
	 ...
	 * @throws SQLException passed on from one of the queries performed in the method
	 */
	 ...
	 * @param statement the statement to use
	 * @param tables the table to query
